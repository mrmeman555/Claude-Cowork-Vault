...
This workspace is part of a multi-repo system. You have full file access to all of these — use absolute paths. When working across these workspaces, also read and follow the CLAUDE.md in each linked repo.
